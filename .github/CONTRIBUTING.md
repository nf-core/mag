...
For further information/help, please consult the [nf-core/mag documentation](https://nf-co.re/nf-core/mag/docs) and don't hesitate to get in touch on the nf-core Slack [#mag](https://nfcore.slack.com/channels/mag) channel ([join our Slack here](https://nf-co.re/join/slack)).
