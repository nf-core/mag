...
workflow MAG {
    ...
    */
    ...
    if (!params.assembly_input) {
        ...
        ch_versions = ch_versions.mix(GUNZIP_ASSEMBLYINPUT.out)
    ...
    if (!params.skip_quast) {
        QUAST(ch_assemblies)
        ch_versions = ch_versions.mix(QUAST.out)
    }
    ...
    */
    ...
    if (!params.skip_prodigal) {
        ...
        ch_versions = ch_versions.mix(PRODIGAL.out)
    }
    ...
    if (!params.skip_binning) {
        ...
        */
        ...
        if (!params.skip_quast) {
            ...
            ch_versions = ch_versions.mix(QUAST_BINS.out)
        ...
        if (!params.skip_prokka) {
            ...
            ch_versions = ch_versions.mix(PROKKA.out)
        }
        ...
        if (!params.skip_metaeuk && (params.metaeuk_db || params.metaeuk_mmseqs_db)) {
            ...
            ch_versions = ch_versions.mix(METAEUK_EASYPREDICT.out)
        }
    }
