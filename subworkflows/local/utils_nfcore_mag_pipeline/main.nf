...
include { INPUT_CHECK               } from '../../local/input_check.nf'
...
workflow PIPELINE_INITIALISATION {
    ...
    //
    validateInputParameters(hybrid)
    ...
    emit:
    raw_short_reads     = INPUT_CHECK.out.raw_short_reads
    raw_long_reads      = INPUT_CHECK.out.raw_long_reads
    input_assemblies    = INPUT_CHECK.out.input_assemblies
