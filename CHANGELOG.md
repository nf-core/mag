...
- [#855](https://github.com/nf-core/mag/pull/855) - Add nf-tests for test_longreadonly, test_longreadonly_alternatives, test_hybrid (added by @dialvarezs)
...
- [#858](https://github.com/nf-core/mag/pull/858) - Fix a single parameter validation failure reporting errors for all parameters by updated nf-schema to 2.5.1 (reported by @Pranjal-Bioinfo, fix by @nvnieuwka nd @jfy133)
