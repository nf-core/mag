...
- [#855](https://github.com/nf-core/mag/pull/855) - Fixed some modules of the GDTBTk subworkflow not being represented in version lists (reported by @user, fix by @jfy133)
