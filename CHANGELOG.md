...
- [#1065](https://github.com/nf-core/mag/pull/1065) - Remove usage of GUNZIP module for bins and unbinned contigs, feeding downstream processes with uncompressed files (by @dialvarezs)
