...
- [#730](https://github.com/nf-core/mag/pull/730) - Added `--busco_db_lineage` to provide a lineage for BUSCO database and `--busco_force_offline` to force offline mode (added by @dialvarezs, @jfy133).
