...
- [#146](https://github.com/nf-core/mag/pull/146) - Add `--binning_map_mode` parameter allowing different mapping strategies for binning (`all_vs_all`, `all_in_group`, `separate`)
