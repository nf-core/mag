...
- [965](https://github.com/nf-core/mag/pull/965) - Add support for the generation of custom contig to bin map files immediately after binning (by @jfy133, @prototaxites)
- [965](https://github.com/nf-core/mag/pull/965) - Add support for optional saving of DAS Tool `contig2bin` map files via `--refine_bins_dastool_savecontig2bin`, with now singular generation process (by @jfy133, @prototaxites)
